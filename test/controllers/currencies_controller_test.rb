...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference("Currency.count") do
      post currencies_url, params: { currency: { code: @currency.code, name: @currency.name, rate: @currency.rate } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { code: @currency.code, name: @currency.name, rate: @currency.rate } }
